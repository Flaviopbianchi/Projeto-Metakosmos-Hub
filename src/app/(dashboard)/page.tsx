...
const stats = [
  { label: "Tasks abertas", value: "—", icon: CheckSquare, color: "violet" },
  { label: "Mensagens Slack", value: "—", icon: MessageSquare, color: "blue" },
  { label: "Eventos hoje", value: "—", icon: Calendar, color: "emerald" },
  { label: "Emails não lidos", value: "—", icon: Mail, color: "amber" },
];
...
export default function DashboardPage() {
  return (
    <div className="flex flex-col flex-1">
      <Header
        title="Dashboard"
        subtitle="Bem-vindo ao Metakosmos Hub"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 rounded-xl p-5">
            ...
            <p className="text-white/40 text-sm">
              Nenhuma indicação este mês ainda.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-violet-500/10 to-indigo-600/5 border border-violet-500/20 rounded-xl p-5">
            ...
            <p className="text-white/40 text-sm">
              Nenhum destaque este mês ainda.
            </p>
          </div>
        </div>
